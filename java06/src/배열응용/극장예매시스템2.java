	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < btn.length; i++) {
			...
			btn[i].addActionListener(new ActionListener() {
				...
				public void actionPerformed(ActionEvent e) {
					...
					// 0은 선택 안된것, 1은 성인, 2는 청소년 
					
					
					if (seat[no] == 1 || seat[no] == 2) { // 이미 예약되어 1이 들어있음. 예약불가
						result.setText("예약불가");
						...
						JOptionPane.showInputDialog(f, "나이가 어떻게 되세요? 1)성인 2) 청소년");
						...
						if (age == 1) {
							adult++;
							JOptionPane.showMessageDialog(f, "성인요금은 10000원 입니다.");
						} else if (age == 2){
							child++;
							JOptionPane.showMessageDialog(f, "청소년요금은 7000원 입니다.");
						} 
					}
				}
			});
		...
		total.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(f, (adult * count * 10000) + (child * count * 7000) + "원 결제요망");
