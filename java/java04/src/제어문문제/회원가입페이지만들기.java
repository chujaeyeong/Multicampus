...
//		b1.setIcon(icon);
		...
		JLabel result = new JLabel(); // 글씨
		text2.setText("로그인결과");

		// 글자 넣는 곳..
		JTextField input1 = new JTextField(10); // id
		JTextField input2 = new JTextField(10); // pw
		JTextField input3 = new JTextField(10); // 이름 
		JTextField input4 = new JTextField(10); // 전화번호 
		// JTextField result = new JTextField(10); // 로그인결과 
